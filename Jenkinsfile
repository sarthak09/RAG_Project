pipeline {
    agent any
    environment {
        DOCKER_HUB_REPO = "sarthakrawat/studyai"
    ...
    stages {
        stage('Checkout Github') {
            steps {
                ...
                checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/sarthak09/Questiongenerator.git']])            }
        }        
